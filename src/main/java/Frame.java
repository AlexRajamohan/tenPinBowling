...
public class Frame {
    ...
    public void checkValidRolls(String value) throws Exception {
        ...
        if (this.index < 10) {
            // 1st roll
            if (Collections.EMPTY_LIST.equals(this.rolls)) {
                // SPARE in 1st roll
        ...
        // 10th frame
            ...
            if (Collections.EMPTY_LIST.equals(this.rolls)) {
                ...
                // Not SPARE NOR STRIKE a 1st roll AND result of roll 1 + result of roll 2 HIGHER OR EQUALS TO 10
                // OR SPARE just after a STRIKE
                ...
                // Has to STRIKE or SPARE to roll a 3rd time
                if ((!RollValuesEnum.STRIKE.getValue().equals(this.rolls.get(0).getValue()) && !RollValuesEnum.SPARE.getValue().equals(this.rolls.get(1).getValue()))
                        ...
                        // Cannot STRIKE if not SPARE NOR STRIKE at 2nd roll
                        || (RollValuesEnum.STRIKE.getValue().equals(value) && !RollValuesEnum.STRIKE.getValue().equals(this.rolls.get(1).getValue())
                        && !RollValuesEnum.SPARE.getValue().equals(this.rolls.get(1).getValue()))
                        // Not SPARE, NOR SPARE at 2nd roll, NOR STRIKE at 1st roll, AND result of 2nd + current roll HIGHER OR EQUALS TO 10
                        ...
                        //NOT SPARE, NOR STRIKE, AND NOT SPARE NOR STRIKE at 2nd roll, AND 2nd + current roll result HIGHER OR EQUALS TO 10
                        || (!RollValuesEnum.SPARE.getValue().equals(value) && !RollValuesEnum.STRIKE.getValue().equals(value)
                        && !RollValuesEnum.SPARE.getValue().equals(this.rolls.get(1).getValue()) && !RollValuesEnum.STRIKE.getValue().equals(this.rolls.get(1).getValue())
                        && RollValuesEnum.getResultByValue(this.rolls.get(1).getValue()) + RollValuesEnum.getResultByValue(value) >= 10)) {
